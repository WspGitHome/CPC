...
import com.wanfangdata.cpc.common.util.PushArticleUtil;
import com.wanfangdata.cpc.common.util.ResultUtil;
import com.wanfangdata.cpc.enums.SysConfigKey;
...
import com.wanfangdata.cpc.module.admin.service.*;
import com.wanfangdata.cpc.module.admin.vo.ArticleConditionVo;
import com.wanfangdata.cpc.module.admin.vo.BaiduPushResVo;
...
public class ArticleController {
    ...
    public String addArticle(Model model) {
        model.addAttribute("article", new BizArticle());
