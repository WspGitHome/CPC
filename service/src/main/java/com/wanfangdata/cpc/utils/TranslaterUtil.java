...
public class TranslaterUtil {
    ...
    private static BiMap<String,String> trans( BiMap<String,String> translater,Column dbcolumnTree) throws Exception{
        ...
        if(children!=null){
            for(Column dbColumn:children){
                ...
                String name=dbColumn.getLibraryName()+Constant.separator_column+dbColumn.getName();
                ...
                if(dbColumn.getChildren()!=null){
                    for(Column dbColumn1:dbColumn.getChildren()){
                        ...
                        String name1=name+Constant.separator_column+dbColumn1.getName();
                        translater.put(name1,code1);
                        if(dbColumn1.getChildren()!=null){
                            for(Column dbColumn2:dbColumn1.getChildren()){
                                String code2=code1+Constant.separator_column+dbColumn2.getId();
                                String name2=name1+Constant.separator_column+dbColumn2.getName();
